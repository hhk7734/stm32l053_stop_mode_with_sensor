 ...
 */
#define BME280_ADDRESS_0 (0x77)    // Primary I2C Address
#define BME280_ADDRESS_1 (0x76)    // Alternate Address
...
public:
    ...
    */
    ...
    BME280();
    ~BME280(void);
    bool begin(I2C_HandleTypeDef *hi2c, uint8_t addr = BME280_ADDRESS_0);
    bool init();
...
protected:
    ...
    int32_t t_fine;       //!< temperature with high resolution, stored as an
                          //!< attribute as this is used for temperature
                          //!< compensation reading humidity and pressure
    ...
    int32_t t_fine_adjust = 0;    //!< add to compensate temp readings and in
                                  //!< turn to pressure and humidity readings
